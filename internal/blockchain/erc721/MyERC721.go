...
//
// Solidity: function createToken() returns()
func (_Erc721 *Erc721Transactor) CreateToken(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _Erc721.contract.Transact(opts, "createToken")
}

// CreateToken is a paid mutator transaction binding the contract method 0x9cbf9e36.
//
// Solidity: function createToken() returns()
func (_Erc721 *Erc721Session) CreateToken() (*types.Transaction, error) {
	return _Erc721.Contract.CreateToken(&_Erc721.TransactOpts)
}

// CreateToken is a paid mutator transaction binding the contract method 0x9cbf9e36.
//
// Solidity: function createToken() returns()
func (_Erc721 *Erc721TransactorSession) CreateToken() (*types.Transaction, error) {
	return _Erc721.Contract.CreateToken(&_Erc721.TransactOpts)
}
