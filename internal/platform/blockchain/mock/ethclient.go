...
// Source: internal/platform/blockchain/ethclient.go
//
...
func (m *MockEthRPCClient) Call(result any, method string, args ...any) error {
	m.ctrl.T.Helper()
...
func (mr *MockEthRPCClientMockRecorder) Call(result, method any, args ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
