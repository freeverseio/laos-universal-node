...
// Source: internal/blockchain/ethclient.go
...
func (mr *MockEthClientMockRecorder) CodeAt(ctx, contract, blockNumber interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockEthRPCClient) Call(result interface{}, method string, args ...interface{}) error {
	m.ctrl.T.Helper()
...
func (mr *MockEthRPCClientMockRecorder) Call(result, method interface{}, args ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
